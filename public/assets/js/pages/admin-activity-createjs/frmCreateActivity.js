...
frmCreateActivity.prototype.validate = function(){
    ...
    if (formRegister.title.trim() === ""){
        ...
        return false;
    } else if (formRegister.input_description === ""){
        cosmo.dialog.error("Erro", "O campo Descrição de Entrada é obrigatório");
        return false;
    } else if (formRegister.input_example === ""){
        cosmo.dialog.error("Erro", "O campo Entrada de Exemplo é obrigatório");
        return false;
        ...
        return false;
    } else if (formRegister.input === ""){
        cosmo.dialog.error("Erro", "O campo Entrada é obrigatório");
        return false;
