...
frmProfileUser.prototype.initialize = function(){
    ...
    return "" === element.fullname.trim() ? (cosmo.dialog.error("Erro", "O campo Nome Completo é obrigatório"), !1) : this.isDataUrl(element.avatar) || (cosmo.dialog.error("Erro", "O campo Imagem é obrigatório!"), !1);
    ...
    console.log(cosmo.urlbase + cosmo.routes_name.USER_UPDATE_PROFILE);
